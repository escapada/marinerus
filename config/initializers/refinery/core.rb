...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Marinerus"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  # config.google_analytics_page_code = "UA-8220214-1"
  ...
  # config.dragonfly_secret = "b1f3e1755f47ffb133604ce2b41ce7895b0556f4fb665677"
  ...
  config.register_stylesheet "admin_style", :media => 'screen'
