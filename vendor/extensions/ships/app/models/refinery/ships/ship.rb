module Refinery
  module Ships
    class Ship < Refinery::Core::BaseModel
      ...
      attr_accessible :title, :meta, :client_id, :category_id, :page_status_id, :owner, :operator, :register_number, :tbn, :status_id, :condition_id, :area_id, :subtype, :appointment, :project, :flag, :registration_id, :construction_date, :construction_place, :renovation_date, :registr_id, :registr_symbol, :period_class, :last_dock, :next_dock, :length, :width, :height, :free_board, :max_draught, :min_draught, :air_draught, :gross_tonnage, :net_tonnage, :deadweight, :loading, :displacement, :dockweight, :tanks, :tanksvolume, :passengers, :engine_id, :enginemodel, :enginequantity, :enginepower, :power_id, :propulsion_id, :propulsionquantity, :fuel_id, :fuelcapacity, :fuel_way, :fuel_port, :autonomy, :speed, :speed_id, :gmdss_id, :crew, :hulltype_id, :hullmaterial_id, :supermaterial_id, :tanksheatingchoice_id, :tankscoolingchoice_id, :doubleboardchoice_id, :doublebottomchoice_id, :doublehullchoice_id, :diesel, :sternthrusters, :stabilizers, :winch, :hook, :cablelength, :cranes, :craneloading, :sails, :sailsarea, :location, :price, :currency_id, :vat_id, :info, :position
